...
class _TakePhotoPageState extends State<TakePhotoPage> {
  ...
  void initState() {    
    ...
    progressDialog.style(progressWidget: Container(padding: EdgeInsets.all(13), child: CircularProgressIndicator(color: Colors.orange)));
  }
          ...
          children: [
            Container(
              margin: EdgeInsets.only(left: 20, right: 20, top: 20),
                child: StsImgView(image: picture, width: MediaQuery.of(context).size.width, height: 300)),
            SizedBox(height: 50,),
            Container(
              ...
              child: ElevatedButton(
                ...
                }, child: Text('Take photo from Camera', style: TextStyle(fontSize: 20),),
              ),
            ),
            Container(
              ...
              child: ElevatedButton(
                ...
                }, child: Text('Take photo from Gallery', style: TextStyle(fontSize: 20),),
              ),
            ),
            Container(
